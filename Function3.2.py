...
messages = [
    ...
    {"role": "user", "content": "请根据我上传的文件内容，提供5个关键词进行描述，如果文件中有主标题，那么选择文件中的主标题，如果没有主标题，请用副标题，如果没有副标题请自己对内容进行总结，注意要精简、准确，请不要自己过度解读，不要添加文件中不存在的内容。你的回复只有标签，请不要有其它内容,关键词和关键词之间不要有其它东西"},
]
...
lables = completion.choices[0].message.content
lable = lables.splitlines()
print(lable[0])
